...
public class StudentDaoImpl implements StudentDao 
{
	...
	public void updateDeatils(Student std) {
		try 
		{
			...
			System.out.println("Studet details updated Successfully...");
		} 
		catch (Exception e) 
		{
			System.out.println("Student deatils not updated due to some error !!!");
			e.printStackTrace();
		}
	...
	public void deleteDetails(Student std) {
		try 
		{
			...
			System.out.println("Studet details deleted Successfully...");
		} 
		catch (Exception e) 
		{
			System.out.println("Student deatils not deleted due to some error !!!");
			e.printStackTrace();
		}
