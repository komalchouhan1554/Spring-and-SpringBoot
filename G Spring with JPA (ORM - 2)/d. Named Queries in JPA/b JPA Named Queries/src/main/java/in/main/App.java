...
public class App 
{
    public static void main(String[] args) 
    {
		...
		try {
			...
			TypedQuery<Student> query2 = entityManager.createNamedQuery("getStdDetailsById",Student.class);
			query2.setParameter("stdId", 3);
			Student std2 = query2.getSingleResult();
			
			System.out.println("Hello "+ std2.getName() +", You got "+ std2.getMarks()+"% marks ⚔️⚔️⚔️");
...
Hibernate: select s1_0.std_id,s1_0.std_marks,s1_0.std_name,s1_0.std_rollno from std_details s1_0 where s1_0.std_id=?

Hello Amit Verma, You got 78.2% marks ⚔️⚔️⚔️
